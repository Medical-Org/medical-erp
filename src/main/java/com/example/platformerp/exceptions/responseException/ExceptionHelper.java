package com.example.platformerp.exceptions.responseException;

import com.example.platformerp.dto.responseData.ErrorData;
import com.example.platformerp.dto.responseData.Response;
import com.example.platformerp.utils.MessageConstants;
...
public class ExceptionHelper {
    ...
    public ResponseEntity<Response<List<ErrorData>>> handleException(RestException ex) {
        ex.printStackTrace();
